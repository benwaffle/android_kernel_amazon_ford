	...
	if (DUAL_CAMERA_MAIN_SENSOR == SensorIdx) {
		if (currSensorName &&
		    ((0 ==
		     ...
		     || (0 == strcmp(SENSOR_DRVNAME_SP0A19_RAW, currSensorName))
		     || (0 ==
	...
	if (On) {
		...
		if (currSensorName
			...
			if (TRUE != kd_gc0312_poweron(mode_name))
			   ...
			   && (0 ==
			       strcmp(SENSOR_DRVNAME_GC0312_RAW,
				      currSensorName))) {
			PK_DBG("is gc0312 RAW on\n");
			if (TRUE != kd_gc0312_poweron(mode_name))
				goto _kdCISModulePowerOn_exit_;
		} else if (currSensorName
			   && (0 ==
			...
			if (TRUE != kd_hi253yuv_poweron(mode_name))
			   ...
			   && (0 ==
			       strcmp(SENSOR_DRVNAME_SP0A19_RAW,
				      currSensorName))) {
			PK_DBG("is SP0A19 on\n");
