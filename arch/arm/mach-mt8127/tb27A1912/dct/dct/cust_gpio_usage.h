...
#define GPIO_GPS_LNA_PIN         (GPIO50 | 0x80000000)
#define GPIO_GPS_LNA_PIN_M_GPIO  GPIO_MODE_00
#define GPIO_GPS_LNA_PIN_M_CLK  GPIO_MODE_02
#define GPIO_GPS_LNA_PIN_M_URTS   GPIO_MODE_01
#define GPIO_GPS_LNA_PIN_M_I2SOUT_LRCK   GPIO_MODE_03
#define GPIO_GPS_LNA_PIN_M_DBG_MON_B   GPIO_MODE_07
#define GPIO_GPS_LNA_PIN_CLK     CLK_OUT3
