...
#ifdef BUILD_LK
	printf("[NT51021]lcm_init func:LK Austin nt51021 3rd inx lcm init ok!\n");
#else
	printk("[NT51021]lcm_init func:Kernel Austin nt51021 3rd inx lcm init ok!\n");
#endif
}
...
static void lcm_suspend_power(void)
{
	...
	MDELAY(10);
	printk("[NT51021]lcm_suspend func:Kernel Austin nt51021 3rd inx lcm suspend ok!\n");
}

static void lcm_resume(void)
{
	init_lcm_registers();
	printk("[NT51021]lcm_init func:Kernel Austin nt51021 3rd inx lcm resume ok!\n");
}
...
LCM_DRIVER nt51021_inx_dsi_vdo_inx_lcm_drv =
{
    	.name			= "nt51021_inx_dsi_vdo_inx_3rd",
