...
#ifdef BUILD_LK
	printf("[OTA7290B]lcm_init func:LK Austin ota7290b lcm init ok!\n");
#else
	printk("[OTA7290B]lcm_init func:Kernel Austin ota7290b lcm init ok!\n");
#endif
}
...
static void lcm_suspend_power(void)
{
	...
	MDELAY(10);
	printk("[OTA7290B]lcm_suspend func:Kernel Austin ota7290b AUO lcm suspend ok!\n");
}

static void lcm_resume(void)
{
	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
	printk("[OTA7290B]lcm_init func:Kernel Austin ota7290b auo lcm resume ok!\n");
}
...
LCM_DRIVER ota7290b_auo_dsi_vdo_kd_lcm_drv = 
{
    	.name			= "ota7290b_auo_dsi_vdo_kd",
