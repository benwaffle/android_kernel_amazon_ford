...
{
	TC358768_DCS_write_1A_1P(0x8f,0xa5);
	MDELAY(20);
	...
	TC358768_DCS_write_1A_1P(0x83,0x00);
	TC358768_DCS_write_1A_1P(0x84,0x00);
	TC358768_DCS_write_1A_1P(0x8f,0x00);
	MDELAY(10);
}
...
#ifdef BUILD_LK
	printf("[NT51021]lcm_init func:LK Austin nt51021 4th txd lcm init ok!\n");
#else
	printk("[NT51021]lcm_init func:Kernel Austin nt51021 4th txd lcm init ok!\n");
#endif
}
...
static void lcm_suspend_power(void)
{
	...
	MDELAY(10);
	printk("[NT51021]lcm_suspend func:Kernel Austin nt51021 4th txd lcm suspend ok!\n");
}

static void lcm_resume(void)
{
	init_lcm_registers();
	printk("[NT51021]lcm_init func:Kernel Austin nt51021 4th txd lcm resume ok!\n");
}
